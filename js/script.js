    ...
    <div class="footer">
        <div class="section-col">
            <div class="social-icons">
                <a href="mailto:fullcerveceria@fullcerveceria.com.ar" target="_blank" rel="noopener" aria-label="Send email">
        ...
        <div class="section-col-img">
            ...
            <div class="banner">
                <p>Aceptamos efectivo, tarjeta de débito y crédito. © 2024 - Full Cerveceria - Munro</p>               
            </div>
        </div>
    </div>
</footer>
